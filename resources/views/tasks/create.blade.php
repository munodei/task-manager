...
@section('content')
    ...
    <h1>Create new Task </h1>
      ...
      <form method="post" action="{{ route('tasks.store') }}">
                            ...
                            <div class="form-group">
                                <label for="project-name">Group Task <span class="required danger">*</span></label>
                                <input  placeholder="Enter name"  id="group-task-name" required name="group_task_name" spellcheck="false" class="form-control" />
                            </div>
