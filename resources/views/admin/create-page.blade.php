...
<!-- Basic Page Needs
================================================== -->
<title>{{get_option('site_name')}} | Create Page</title>
<meta charset="utf-8">
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<div class="content with-padding padding-bottom-0">
                            ...
                            <form action="{{ route('create_new_page') }}" class="form-horizontal" method="post" id="add-page" name="add-page">
                            {!! csrf_field() !!}
                                    <div class="row">
                                        <div class="col-xl-12 {{ $errors->has('title')? 'has-error':'' }}">
                                            <h5>@lang('app.title')</h5>
                                            <div class="submit-field">
                                            <input type="text" class="with-border" id="title" value="{{ old('title') }}" name="title" placeholder="@lang('app.title')">
                                        ...
                                        <div class="col-xl-12 {{ $errors->has('post_content')? 'has-error':'' }}">
                                            <h5>Post Content</h5>
                                            <div class="submit-field">
                                            <textarea name="post_content" id="post_content" class="with-border"  rows="6">{{ old('post_content') }}</textarea>
                                        ...
                                        <div class="col-xl-6 {{ $errors->has('show_in_header_menu')? 'has-error':'' }}">
                                            ...
                                            <div class="submit-field">
                                            <div class="checkbox">
                                                <input type="checkbox" id="show_in_header_menu" name="show_in_header_menu" >
                                        ...
                                        <div class="col-xl-6 {{ $errors->has('show_in_footer_menu')? 'has-error':'' }}">
                                            ...
                                            <div class="submit-field">
                                            <div class="checkbox">
                                                <input type="checkbox" id="show_in_footer_menu" name="show_in_footer_menu" >
                                        ...
                                        <div class="col-xl-12">
                                        <button class="button ripple-effect big margin-top-30" type="submit" form="add-page">@lang('app.save_new_page') <i class="icon-line-awesome-folder-open-o"></i></button>
                                        </div>
                                            </div>
                            </form>
