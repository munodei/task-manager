				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<div class="content with-padding padding-bottom-0">
                            ...
                            <form action="{{ route('parent_categories') }}" class="form-horizontal" method="post" id="add-category1" name="add-category1">
                            {!! csrf_field() !!}
                                    <div class="row">
                                        <div class="col-xl-4">
                                        ...
                                        <div class="col-xl-4 {{ $errors->has('category_name')? 'has-error':'' }}">
                                            ...
                                            <div class="submit-field">
                                                <input type="text" class="with-border" id="category_name" value="{{ old('category_name') }}" name="category_name" placeholder="@lang('app.category_name')">
                                        ...
                                        <div class="col-xl-12 {{ $errors->has('description')? 'has-error':'' }}">
                                            ...
                                            <div class="submit-field">
                                                <textarea name="description" id="description" class="with-border"  rows="6">{{ old('description') }}</textarea>
                                        ...
                                        <div class="col-xl-12">
                                        <button class="button ripple-effect big margin-top-30" type="submit" form="add-category1">Add Category <i class="icon-line-awesome-folder-open-o"></i></button>
                                        </div>
                                            </div>
                            </form>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <div class="clearfix">
                                                                                                        ...
                                                                                                        <a href="{{ route('edit_categories', $category->id) }}" class="btn btn-info btn-xs"><i style="color:green;" class="icon-feather-edit-2"></i> </a>
                                                                                                        <a href="javascript:;" class="btn btn-danger btn-xs" data-id="{{ $category->id }}"><i style="color:red;" class="icon-material-outline-delete"></i> </a>
                                                                                                        </span>
                                                                                                    ...
                                                                                                    @if($category->sub_categories->count() > 0)
                                                                                                        @foreach($category->sub_categories as $sub_cat)
                                                                                                            <div class="clearfix">
                                                                                                                ...
                                                                                                                <span class="pull-right">
                                                                                                                    <a href="{{ route('edit_categories', $sub_cat->id) }}" class="btn btn-info btn-xs"><i style="color:green;" class="icon-feather-edit-2"></i> </a>
                                                                                                                    <a href="javascript:;" class="btn btn-danger btn-xs" data-id="{{ $sub_cat->id }}"><i style="color:red;" class="icon-material-outline-delete"></i> </a>
                                                                                                                </span>
