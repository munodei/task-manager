...
<!-- Basic Page Needs
================================================== -->
<title>{{get_option('site_name')}} | Social Url Settings</title>
<meta charset="utf-8">
			...
			<div class="dashboard-headline">
				...
				<nav id="breadcrumbs" class="dark">
					<ul>
						...
						<li><a href="{{route('social-url-settings')}}">Social Site Login Settings</a></li>
					</ul>
				</nav>
			</div>
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<!-- Headline -->
						<div class="headline">
							<h3><i class="icon-line-awesome-wechat"></i> Social Site Login Settings</h3>
						</div>
