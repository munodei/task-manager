...
class SettingsController extends Controller
{
    ...
    public function AccountSettings(){
        ...
        return view('settings', compact('countries'));
    }
    ...
    public function GeneralSettings(){
        ...
        return view('admin.general-settings', compact('title','countries'));
    }

    public function PaymentSettings(){
        $title = trans('app.payment_settings');
        return view('admin.payment-settings', compact('title'));
    }
    ...
    public function SocialSettings(){
        ...
        return view('admin.social-settings', compact('title'));
    }
    ...
    public function reCaptchaSettings(){
        ...
        return view('admin.re_captcha-settings', compact('title'));
    }
    public function OtherSettings(){
        $title = trans('app.other_settings');
        return view('admin.other-settings', compact('title'));
    }
    ...
    public function ThemeSettings(){
        ...
        return view('admin.theme-settings', compact('title'));
    }
    public function modernThemeSettings(){
        $title = trans('app.modern_theme_settings');
        return view('admin.modern-theme-settings', compact('title'));
    }

    public function SocialUrlSettings(){
        $title = trans('app.social_url_settings');
        return view('admin.social-url-settings', compact('title'));
    }
